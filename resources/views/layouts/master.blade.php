    ...
    <nav class="navbar custom-navbar navbar-expand-md navbar-light bg-primary sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">                     
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('Acceuil_u')}}">Acceuil</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @foreach($lesia as $i)
                            <a class="dropdown-item" href="{{route('ia.article_user',['id'=>$i->id,'nomia'=>$i->nom])}}">{{$i->nom}}</a>
                            @endforeach
                        </div>
                    </li>
                </ul>
                <div class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="{{route('form_log')}}" class="ml-4 btn btn-dark mt-1 btn-sm">Admin</a>
                    </li>
                </div>
            </div>
        </div>
